// Cloudflare Pages Function：/music/* 同源代理 → Meting-API
//
...
const UPSTREAM = 'https://meting.naihee.com/api'
...
export const onRequest: PagesFunction = async (context) => {
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: 'music proxy error', message: e instanceof Error ? e.message : String(e) }), {
      status: 500,
      headers: {
