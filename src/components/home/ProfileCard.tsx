    ...
    <div className="widget-card p-4">
      ...
      <div className="flex justify-center gap-2">
        <a href="https://github.com" target="_blank" rel="noopener noreferrer"
          ...
          title="GitHub">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-[rgb(var(--text-secondary))]">
        ...
        <a href="https://t.me/" target="_blank" rel="noopener noreferrer"
          className="w-9 h-9 rounded-full bg-[rgb(var(--bg-secondary))] flex items-center justify-center
            hover:bg-blue-500/10 hover:scale-110 transition-all duration-200"
          title="Telegram">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-[rgb(var(--text-secondary))]">
        ...
        <a href="mailto:hello@example.com" target="_blank" rel="noopener noreferrer"
          className="w-9 h-9 rounded-full bg-[rgb(var(--bg-secondary))] flex items-center justify-center
            hover:bg-red-500/10 hover:scale-110 transition-all duration-200"
          title="Email">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-[rgb(var(--text-secondary))]">
