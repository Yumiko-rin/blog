...
export const BG_IMAGES: BgImage[] = [
  ...
  { id: 7,  url: '/bg/anime_01.webp',   thumb: '/bg/anime_01.webp',   label: '幻想花田' },
  { id: 8,  url: '/bg/anime_02.webp',   thumb: '/bg/anime_02.webp',   label: '樱花少女' },
  { id: 9,  url: '/bg/anime_03.webp',   thumb: '/bg/anime_03.webp',   label: '森林夕阳' },
  { id: 10, url: '/bg/anime_04.webp',   thumb: '/bg/anime_04.webp',   label: '白裙草地' },
  { id: 11, url: '/bg/anime_05.webp',   thumb: '/bg/anime_05.webp',   label: '猫娘夏日' },
]
