...
export const ARTICLES: Article[] = [
  {
    ...
    "cover": "https://loremflickr.com/1200/600/vscode?lock=21",
    "category": "软件",
    "tags": [
      "VS Code",
      "编辑器",
  ...
  },
  {
    ...
    "cover": "https://loremflickr.com/1200/600/blog?lock=22",
    "category": "技术",
    "tags": [
      "Hugo",
      "Hexo",
  ...
  },
  {
    ...
    "cover": "https://loremflickr.com/1200/600/notebook?lock=23",
    "category": "软件",
    "tags": [
      "Notion",
      "笔记",
  ...
  },
  {
    ...
    "cover": "https://loremflickr.com/1200/600/code?lock=24",
    "category": "软件",
    "tags": [
      "Cursor",
      "AI编程",
  ...
  },
  {
    ...
    "cover": "https://loremflickr.com/1200/600/robot?lock=25",
    "category": "技术",
    "tags": [
      "Ollama",
      "本地大模型",
  ...
  },
  {
    ...
    "cover": "https://loremflickr.com/1200/600/artificialintelligence?lock=26",
    "category": "软件",
    "tags": [
      "DeepSeek",
      "Agent",
  ...
  },
  {
    ...
    "cover": "https://loremflickr.com/1200/600/writing?lock=27",
    "category": "技术",
    "tags": [
      "Markdown",
      "写作",
  ...
  },
  {
    ...
    "cover": "https://loremflickr.com/1200/600/crystal?lock=28",
    "category": "软件",
    "tags": [
      "Obsidian",
      "笔记",
  ...
  },
  {
    ...
    "cover": "https://loremflickr.com/1200/600/cloud?lock=29",
    "category": "技术",
    "tags": [
      "Cloudflare",
      "CDN",
...
/** 按标签聚合 */
export function getArticlesByTag(): Record<string, Article[]> {
...
/**
 * 异步加载文章（后台发布的 + 静态内置的合并）
 * 后台发布的文章排在前面，静态文章作为兜底。
 */
...
// 监听跨标签页缓存失效通知（后台管理页面删除文章后广播）
if (typeof window !== 'undefined') {
  window.addEventListener('storage', (e) => {
    if (e.key === 'article-cache-invalidated') {
      invalidateArticleCache()
    }
  })
}

export async function loadArticles(force = false): Promise<Article[]> {
  if (!force && _cachedArticles && Date.now() - _cacheTime < CACHE_MS) {
  ...
  try {
    ...
    if (res.ok) {
      ...
      // 版本号变化说明后台有增删改，强制刷新缓存
      if (serverVersion && serverVersion !== _cachedVersion) {
        _cachedArticles = null
      }
      const kvArticles: Article[] = (data.list || []).map((a: any) => ({
        id: a.id || a.slug,
        slug: a.slug || a.id,
        title: a.title || '无标题',
        excerpt: a.excerpt || '',
        ...
        views: a.views || 0,
        likes: a.likes || 0,
        readingTime: a.readingTime || Math.max(1, Math.ceil((a.content || '').length / 500)),
        isPinned: a.isPinned || false,
        wordCount: a.wordCount || (a.content || '').length,
      }))
      _cachedArticles = kvArticles
      _cacheTime = Date.now()
